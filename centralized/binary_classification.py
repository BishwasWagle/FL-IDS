...
def plot_metrics(history, state):
    ...
    plt.savefig(f'../results/centralized/{state}/accuracy_plot.jpg')
    plt.close()
    ...
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    plt.savefig(f'../results/centralized/{state}/loss_plot.jpg')
    plt.close()
...
def evaluate_model(model, X_test, y_test, state):
    ...
    plt.savefig(f'../results/centralized/{state}/confusion_matrix.jpg')
    plt.close()
    ...
    plt.savefig(f'../results/centralized/{state}/normalized_confusion_matrix.jpg')
    plt.close()
